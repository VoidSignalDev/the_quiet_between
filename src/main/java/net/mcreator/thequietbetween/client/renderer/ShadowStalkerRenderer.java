...
public class ShadowStalkerRenderer extends HumanoidMobRenderer<ShadowStalkerEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private ShadowStalkerEntity entity = null;
	...
	@Override
	public void extractRenderState(ShadowStalkerEntity entity, HumanoidRenderState state, float partialTicks) {
