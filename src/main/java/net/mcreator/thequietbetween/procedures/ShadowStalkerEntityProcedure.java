...
public class ShadowStalkerEntityProcedure {
	public static Entity execute(LevelAccessor world) {
		return findEntityInWorldRange(world, ShadowStalkerEntity.class, TheQuietBetweenModVariables.MapVariables.get(world).playerX, TheQuietBetweenModVariables.MapVariables.get(world).playerY,
