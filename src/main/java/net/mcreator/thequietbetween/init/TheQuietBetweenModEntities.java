...
import net.mcreator.thequietbetween.entity.WeepingAngelEntity;
...
public class TheQuietBetweenModEntities {
	...
	public static final DeferredHolder<EntityType<?>, EntityType<WeepingAngelEntity>> WEEPING_ANGEL = register("weeping_angel",
			EntityType.Builder.<WeepingAngelEntity>of(WeepingAngelEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).fireImmune().ridingOffset(-0.6f).sized(0.6f, 1.8f));
	...
	public static void registerAttributes(EntityAttributeCreationEvent event) {
		...
		event.put(WEEPING_ANGEL.get(), WeepingAngelEntity.createAttributes().build());
	}
}