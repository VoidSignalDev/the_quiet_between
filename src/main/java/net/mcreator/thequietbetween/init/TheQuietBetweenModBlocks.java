...
import net.mcreator.thequietbetween.block.*;
...
public class TheQuietBetweenModBlocks {
	...
	public static final DeferredBlock<Block> SPRUCE_DOOR_TELEPORTER_SPAWN;
	static {
		...
		SPRUCE_DOOR_TELEPORTER_SPAWN = register("spruce_door_teleporter_spawn", SpruceDoorTeleporterSpawnBlock::new);
	}
